...
{
    // NOTE: You can use the "Rename" command on the "Refactor" menu to change the class name "JobOpeningService" in code, svc and config file together.
    // NOTE: In order to launch WCF Test Client for testing this service, please select JobOpeningService.svc or JobOpeningService.svc.cs at the Solution Explorer and start debugging.
